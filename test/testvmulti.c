...
Usage(void)
{
    printf("Usage: testvmulti </multitouch | /mouse | /digitizer | /joystick | /keyboard | /vendormsg>\n");
}
    ...
    )
{
    ...
    else if (strcmp(argv[1], "/vendormsg") == 0)
    {
